...
<html>
  <head>
    ...
    <title>update Student Info page </title>
  ...
  <body>
   <h1 id="head">修改教师信息</h1>
		...
		<ul id="navigation" style="height: 20px;">
			...
			<form action="<%=basePath%>ManagerSvl?operate=updatestudent" method="post"><div style="position: absolute;top: 50%;left: 50%;-ms-transform: translate(-50%,-50%);-moz-transform: translate(-50%,-50%);-o-transform: translate(-50%,-50%);transform: translate(-50%,-50%);"">
			<table align="center" > 
				<tr style="text-align: center;">
					<td style="width: 80px; text-align: center;">学号</td>
					<td><input type="text" name="uno" value="${student.uno}" readonly/></td>
				</tr>
				<tr style="text-align: center; ">
					<td  style="width: 80px;text-align: center;">学生姓名</td>
					<td><input type="text" name ="sname" value="${student.sname}"/></td>
				</tr>
				<tr style="text-align: center;">
					<td style="width: 80px; text-align: center;">学生电话</td>
					<td><input type="text" name="sphone" value="${student.sphone}"/></td>
				</tr>
				<tr style="text-align: center;">
					<td colspan="2" align="center" style="width: 80px;text-align: center;" >
					<input type="submit" value="修改信息" align="middle"/></td>
