...
<html>
  <head>
    ...
    <title>update  Manager Info page </title>
  ...
  <body>
   <h1 id="head">修改个人信息</h1>
		...
		<ul id="navigation" style="height: 20px;">
			...
			<form action="<%=basePath%>ManagerSvl?operate=updatemanager" method="post" id="myform"><div style="position: absolute;top: 50%;left: 50%;-ms-transform: translate(-50%,-50%);-moz-transform: translate(-50%,-50%);-o-transform: translate(-50%,-50%);transform: translate(-50%,-50%);"">
			<table align="center" > 
				<tr style="text-align: center;">
				
					<td style="width: 80px; text-align: center;">用户编号</td>
					<td><input type="text" name="uno" value="${manager.uno}" readonly/></td>
				</tr>
				<tr style="text-align: center; ">
					<td  style="width: 80px;text-align: center;">姓名</td>
					<td><input type="text" name ="mname" value="${manager.mname}"/></td>
				</tr>
				<tr style="text-align: center;">
					<td style="width: 80px; text-align: center;">电话</td>
					<td><input type="text" name="mphone" value="${manager.mphone}"/></td>
				</tr>
				<tr style="text-align: center;">
					<td colspan="2" align="center" style="width: 80px;text-align: center;">
					<input type="button" value="修改个人信息" align="middle" style="cursor:pointer" id="button"/></td>
