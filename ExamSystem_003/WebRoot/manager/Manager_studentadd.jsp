...
<html>
  <head>
    ...
    <title>Manager add Student  page</title>
  ...
  <body>
   <h1 id="head">添加学生</h1>
		...
		<ul id="navigation" style="height: 20px;">
			...
			<form action="<%=basePath%>ManagerSvl?operate=addstudent" method="post"><div style="position: absolute;top: 50%;left: 50%;-ms-transform: translate(-50%,-50%);-moz-transform: translate(-50%,-50%);-o-transform: translate(-50%,-50%);transform: translate(-50%,-50%);"">
			<table align="center" > 
				...
				<tr style="text-align: center;">
					...
					<input type="submit" value="添加学生" align="middle"/></td>
