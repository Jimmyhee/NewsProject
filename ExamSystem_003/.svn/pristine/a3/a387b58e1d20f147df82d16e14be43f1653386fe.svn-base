  ...
  <body>
   <h1 id="head">修改个人信息</h1>
		...
		<ul id="navigation" style="height: 20px;">
			...
			<form action="<%=basePath%>StudentSvl?operate=updateStudentInfo" method="post" id="myform"><div style="position: absolute;top: 50%;left: 50%;-ms-transform: translate(-50%,-50%);-moz-transform: translate(-50%,-50%);-o-transform: translate(-50%,-50%);transform: translate(-50%,-50%);"">
			<table align="center" > 
