...
<div class="main">
	...
	<div class="test_main">
		<div class="nr_left">
			<div class="test">
				<form action="TeacherSvl?operate=checkStuPaper" method="post" style="padding-bottom:100px">
					<div class="test_title">
						<font><input type="submit" name="test_jiaojuan" value="确认"></font>
						...
						<div class="test_content">
							<div class="test_content_title">
								<h2>考试试题</h2>
								<p>
									<span>共</span><i class="content_lit">${fn:length(questions)}</i><span>题</span><span></span>
								</p>
								<div align="right">
									<input type="button" name="collect" value="计算总分"  onclick ="sum()" style="width: 76px;height: 24px; ">
									<input type="text" name="allpoint" id ="allpoint" style="height: 28px;width: 100px">
								</div>
							</div>
						</div>
