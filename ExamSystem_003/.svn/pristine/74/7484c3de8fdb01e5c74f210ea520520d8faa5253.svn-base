  ...
  <body>
   <h1 id="head">修改密码</h1>
		...
		<ul id="navigation" style="height: 20px;">
			...
			<form action="<%=basePath%>UpdatePswSvl" method="post"><div style="position: absolute;top: 50%;left: 50%;-ms-transform: translate(-50%,-50%);-moz-transform: translate(-50%,-50%);-o-transform: translate(-50%,-50%);transform: translate(-50%,-50%);">
			<table align="center" > 
				<tr style="text-align: center;">
					<td style="width: 80px; text-align: center;">用户编号</td>
					<td><input type="text" name="uno" value="${user.uno}" readonly/></td>
				</tr>
				<tr style="text-align: center; ">
					<td  style="width: 80px;text-align: center;">用户原密码</td>
					<td><input type="password" name ="password"/></td>
				</tr>
				<tr style="text-align: center;">
					<td style="width: 80px; text-align: center;">用户新密码</td>
					<td><input type="password" name="password1"/></td>
				</tr>
				<tr style="text-align: center;">
					<td style="width: 80px; text-align: center;">确认密码</td>
					<td><input type="password" name="password2"/></td>
				</tr>
				<tr style="text-align: center;">
					<td colspan="2" align="center" style="width: 80px;text-align: center;" >
					<input type="submit" value="修改密码" align="middle"/></td>
				</tr>	
				<tr>
				<td colspan="2" align="center" style="width: 80px;text-align: center;" >${msg}</td>
				</tr>
